...
<body>
	<header>
		...
		<div class="row">
			<div class="col-2"></div>
			<div class="col-2">
				<a class="www" href="#">禮品專區</a><a class="www" href="#">探索活動</a>
			</div>
			<div class="col-5">
				<div class="box">
			...
			<div class="col-3">
				<a class="www" href="#">註冊</a>|<a class="www" href="#">登入</a>
			</div>
		</div>
		<!-- 未登入結束 -->
		<div class="row">
		...
		<div class="row">
			...
			<ul class="drop-down-menu">
				<li><a href="#"><iconify-icon
					...
					<ul>
						<li><a href="#"><iconify-icon
									class="sign-out" icon="heroicons:cog-8-tooth" width="20"
									height="20"></iconify-icon> 設定</a></li>
						<li><a href="#"><iconify-icon
									class="sign-out" icon="heroicons:ticket" width="20" height="20"></iconify-icon>
								票券訂單</a></li>
						<li><a href="#"><iconify-icon
									class="sign-out" icon="heroicons:gift" width="20" height="20"></iconify-icon>
								禮品訂單</a></li>
						<div class="buttonOUT">
							<form action="MemberServlet" method="POST">
								<li id="Signout"><a href="#"> <iconify-icon
											class="sign-out"
											icon="heroicons:arrow-right-on-rectangle-20-solid" width="20"
											height="20" style="margin: 0px -7px 0px 2px;"></iconify-icon>
										<input type="submit" value="登出"> <input type="hidden"
										name="action" value="logout"></a></li>
