...
<link rel="stylesheet" type="text/css" href="${context}/back-organizer-end/product/css/addProduct.css" />
...
<body>
	<div class="my_size">
		...
		<div class="row">
			...
			<form method="post" action="<%=request.getContextPath()%>/ProductServlet" name="form1" enctype="multipart/form-data">
				<div class="div_text col-md-5">
					<table>
						...
						<tr>
							<td>商品單價：</td>
							<td><input type="text" name="unitPrice" size="20"
								class="form-control"
				...
				<div class="div_img col-md-5">
					...
					<ul class="picture_list">
						<li>
							<img src="${context}/back-organizer-end/product/img/Product_Image_Default.jpg" class="preview">
						</li>
					</ul>
