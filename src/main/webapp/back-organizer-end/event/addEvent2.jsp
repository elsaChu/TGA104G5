...
<!-- 	<form method="post" action="../../addEmpServlet" name="eventForm1"> -->
	<form method="post" action="<%=request.getContextPath()%>/addEventServlet" name="eventForm1" enctype="multipart/form-data" id="eventForm">
		...
		<span>上傳封面：</span><input type="file" id="bigImg" name="bigImg" class="inImg" accept="image/*">
  		<ul class="picture_list">
    	</ul>
    	
    	<span>上傳輪播圖：</span><input type="file" name="smallImg" class="inImg" accept="image/*">
  		<ul class="picture_list">
    	</ul>
