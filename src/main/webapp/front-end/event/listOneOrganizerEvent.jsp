...
List<Map> list = orderSvc.selectOrderByOrganizer(1);
...
<!-- 					</FORM> -->
	...
	<!-- 					<th>活動名稱</th> -->
					...
					<%@ include file="page1_bylistOneOrganizer.file"%>
	...
	<%-- 						<td>${orderVO.eventName}</td> --%>
		...
		<!-- order list -->
			<div class="row div_search_right" >		
				<%@ include file="page1_1_bylistOneOrganizer.file"%>
				<%@ include file="page2_bylistOneOrganizer.file"%>
			</div>
		</div>
</body>
</html>