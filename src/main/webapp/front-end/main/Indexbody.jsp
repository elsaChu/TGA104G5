	    ...
	    <input type="hidden" name="memid" value="${sessionScope.memberVO}" id="memid" />
            <div class="gallery js-flickity" data-flickity-options='{ "wrapAround": true }'>
                <div class="gallery-cell">
                    <img src="images/sampleEvents/img10.jpg" alt="">
                </div>
                <div class="gallery-cell">
                    <img src="images/sampleEvents/img9.jpg" alt="">
                </div>
                <div class="gallery-cell">
                    <img src="images/sampleEvents/img12.jpg" alt="">
                </div>
                <div class="gallery-cell">
                    <img src="images/sampleEvents/img4.jpg" alt="">
                </div>
                <div class="gallery-cell">
                    <img src="images/sampleEvents/img8.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="images/sampleEvents/img1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="images/sampleEvents/img2.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="images/sampleEvents/img3.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
...
<!--     <script src="js/bootstrap.min.js"></script> -->
    ...
    <script src="js/indexMainCopy.js"></script>
    <!-- flickity -->
